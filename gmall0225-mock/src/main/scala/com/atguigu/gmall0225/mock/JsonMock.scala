package com.atguigu.gmall0225.mock

import java.util.Date

import com.alibaba.fastjson.{JSON, JSONObject}
import com.atguigu.gmall0225.mock.util.{LogUploader, RandomNumUtil, RandomOptions}
...
object JsonMock {
    ...
    val eventOpts = RandomOptions(
        ("addFavor", 10), ("addComment", 5),
        ("addCart", 10), ("clickItem", 3),
        ("coupon", 80))
    ...
    def initOneStartupLog(): String = {
        ...
        val uid: String = "" + RandomNumUtil.randomInt(1, 10)
